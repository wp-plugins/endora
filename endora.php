...
wp_register_style('styleSheet', plugins_url('reklama-wplugin-style.php', __FILE__)); /* v2.1 */
...
wp_enqueue_script(jscolor, plugins_url('jscolor.js', __FILE__)); /* v2.6 */ ?>
<div class="wrap">
...
class Widg01End extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<div id="reklama-wplugin"><endora></div>
